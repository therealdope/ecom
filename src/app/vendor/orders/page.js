  ...
  return (
    <VendorLayout>
      <div className="px-4 py-6 sm:px-6 lg:px-8 relative">
        <h2 className="text-2xl font-semibold text-indigo-700 mb-6">Customer Orders</h2>
        ...
        <div className="flex flex-wrap gap-4 mb-6 items-end">
          ...
          <div>
            <label className="block text-sm text-gray-600">Payment</label>
            <select
              value={filterPayment}
          ...
          <button
            ...
            className="bg-gray-100 text-sm border border-gray-300 rounded px-3 py-1 hover:bg-gray-200"
          >
            Clear Filters
          </button>
        </div>
        ...
        {selectedOrder && (
          ...
          >
            ...
            >
              ...
              <p className="text-sm mb-1 text-gray-600">
                <strong>Payment:</strong> {selectedOrder.payment?.[0]?.status || 'PENDING'}
              </p>
              <p className="text-sm mb-1 text-gray-600">
                <strong>Address:</strong> {formatAddress(selectedOrder.address)}
              </p>
